      ...
      <?php include("partials/_navbar.php") ?>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            $reg = $_SESSION['mobile'];
            $get_reg = "SELECT * FROM reg WHERE mobile='$reg'";
            $run_reg = mysqli_query($con,$get_reg);
            $row=mysqli_fetch_array($run_reg);        
            $user_id = $row['user_id'];
            $name = $row['name'];echo " Hi $name, Welcome to TROLLA Dashboard";
            ?>
            ...
            echo "
              ...
              <div class='col-md-4 stretch-card grid-margin'>
                <div class='card bg-gradient-info card-img-holder text-white'>
                  <div class='card-body'>
                     <br>
                    <h4 class='font-weight-normal mb-3' >Quoted Loads <b class=' mdi-24px float-right'>$quote</b>
                    </h4>
          ...
          <!--   =================================================================================== -->
            ...
            <tr>
              ...
              <td> <a  href=''style='color:#ff4a37;'>$m_name</a></td>
              <td>$quantity</td>
              <td>$p_add</td>
              <td>$d_add</td>
              <td>$status</td>
