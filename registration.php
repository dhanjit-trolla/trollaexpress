...
<?php
    ...
    if(isset($_POST["submit"])){
      ...
      $mobile = $_POST["mobile"];
        ...
        $check_query = mysqli_query($con, "SELECT * FROM reg where email ='$email' And mobile ='$mobile'");
        ...
        if(!empty($mobile) && !empty($email) && !empty($password)){
            if($rowCount > 0){
                ...
                $result = mysqli_query($con, "INSERT INTO reg (user, mobile, email, password, v_status) VALUES ('$user', '$mobile', '$email', '$password', 0)");
                ...
                if($result){
                    ...
                    $mail->Username='maroof.trolla@gmail.com';
                    $mail->Password='1@mpassword';
    
                    $mail->setFrom('maroof.trolla@gmail.com', 'OTP Verification');
                    ...
                    <br><br>
                    <p>With regrads,</p>
                    <b>Stella Express and Logistics Pvt. Ltd.</b>";
...
<section class="u-clearfix u-image u-shading u-section-2" id="carousel_4899" data-image-width="1600" data-image-height="1067">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-container-style u-group u-opacity u-opacity-80 u-preserve-proportions u-radius-20 u-shape-round u-white u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <h3 class="u-custom-font u-text u-text-default u-text-1">Signup to Trolla</h3>
            ...
            <div class="u-form u-form-1">
              <form action="" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;" redirect="true">
                <div class="u-form-group u-form-partition-factor-2 u-form-select u-label-top u-form-group-1">
                  <label for="select-3032" class="u-form-control-hidden u-label"></label>
                  <div class="u-form-select-wrapper">
                    <select id="select-3032" name="user" style="border-color: transparent;" class="u-border-1 u-custom-font u-input u-input-rectangle u-radius-7 u-white u-input-1">
                ...
                <div class="u-form-group u-form-name u-form-partition-factor-2 u-label-top">
                  ...
                  <input type="text" placeholder="Enter your number" id="name-e51e" name="mobile" onkeyup="numbersOnly(this)" style="border-color: transparent;" class="u-border-1 u-custom-font u-input u-input-rectangle u-radius-7 u-white u-input-2" required="" autocomplete="new-password">
                </div>
                <div class="u-form-email u-form-group u-label-top u-form-group-3">
                  <label for="email-d606" class="u-form-control-hidden u-label"></label>
                  <input type="email" placeholder="Enter a valid email address" id="email-d606" name="email" style="border-color: transparent;" class="u-border-1 u-custom-font u-input u-input-rectangle u-radius-7 u-white u-input-3" required="" autocomplete="new-password">
                </div>
                <div class="u-form-email u-form-group u-label-top">
                  <label for="email-e51e" class="u-form-control-hidden u-label"></label>
                  <input type="password" placeholder="Enter your password" id="password" name="password" style="border-color: transparent;" class="u-border-1 u-custom-font u-input u-input-rectangle u-radius-7 u-white u-input-4" required="">
                ...
                <div class="u-align-center u-form-group u-form-submit">
                  ...
                  <button type="submit" name="submit" value="submit" class="u-border-none u-btn u-btn-round u-btn-submit u-button-style u-custom-color-1 u-custom-font u-hover-white u-radius-6 u-text-hover-custom-color-1 u-btn-1">Register</button>
                </div>
                
              </form>
            </div>
            <p class="u-custom-font u-text u-text-default u-text-2">Already Register? <a href="login" data-page-id="62825375" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-custom-color-1 u-btn-2">Click here</a>
            </p>
          </div>
        </div>
      </div>
