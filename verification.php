      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-container-style u-group u-opacity u-opacity-80 u-preserve-proportions u-radius-20 u-shape-round u-white u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <h3 class="u-custom-font u-text u-text-default u-text-1">OTP VERIFICATION</h3>
            <div class="u-border-1 u-border-custom-color-1 u-line u-line-horizontal u-line-1"></div><br>
                <br>
            <div class="u-form u-form-1">
              <form action="" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;" redirect="true">
                ...
                <div class="u-form-group u-form-name">
                  ...
                  <input type="text" placeholder="Enter Your OTP" id="otp" name="otp_code"
                  onkeyup="numbersOnly(this)" class="u-border-1 u-border-custom-color-1 u-custom-font u-input u-input-rectangle u-radius-7 u-white u-input-1" required="" autocomplete="new-password">
                </div>
                ...
                <div class="u-align-center u-form-group u-form-submit">
                 <!--  <a href="#" class="u-border-none u-btn u-btn-round u-btn-submit u-button-style u-custom-color-1 u-custom-font u-hover-white u-radius-6 u-text-hover-custom-color-1 u-btn-1">Submit</a>
                  <input type="submit" value="submit" class="u-form-control-hidden"> -->
                   <button type="submit" name="verify" value="Verify" class="u-border-none u-btn u-btn-round u-btn-submit u-button-style u-custom-color-1 u-custom-font u-hover-white u-radius-6 u-text-hover-custom-color-1 u-btn-1">OTP Submit</button>
                </div>
    ...
    if(isset($_POST["verify"])){
        ...
        if($otp != $otp_code){
           ...
           <?php
            ...
            mysqli_query($con, "UPDATE reg SET v_status = 1 WHERE email = '$email'");
            ?>
             <script>
