             ...
             <div class="row">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card badge-outline-light">
                  <div class="card-body">
                    <h4 class="card-title">COMPLETED LOADS</h4>
                    ...
                    <tbody>
                      ...
                      $get_myload = "SELECT * FROM loads  inner join reg on loads.user_id = reg.user_id where loads.status='Complete' and reg.user='Transporter'";
