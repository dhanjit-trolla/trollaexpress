      ...
      <?php include("partials/_navbar.php") ?>
       <div class="main-panel">
            ...
            if ( isset( $_GET[ 'user_id' ] ) ) {
              ...
              while ( $row_user = mysqli_fetch_array( $run_user ) ) {
                ...
                $attch_file = $row_user[ 'attch_file' ];
                 $pan_number = $row_user[ 'pan_number' ];
                $attch_file1 = $row_user[ 'attch_file1' ];
            ...
            ?>
             ...
             <div class="col-12 grid-margin stretch-card">
                <div class="card badge-outline-light">
                  <div class="card-body">
                    <h4 class="card-title" style="text-transform: uppercase; ">Un-Verified User</h4>
                    ...
                    <form class="forms-sample" action="#" method="post">
                      ...
                      <div class="form-group">
                        <label for="exampleInputName1" style="color: #000;">PAN Card Number</label>
                         <strong id="exampleInputName1" class="form-control"><?php echo $pan_number ?></strong>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1" style="color: #000;">Document</label>
                        <a href="../gst_file/<?php echo $attch_file ?>"> <?php echo $attch_file ?> </a> || 
                        <a href="../pan_file/<?php echo $attch_file1 ?>"> <?php echo $attch_file1 ?> </a>
                      </div>

                   
                      <div class="form-group">
                        <label for="exampleTextarea1" style="color: #000;">User Approval</label>
                        <select  name="status" class="form-control" required >
                <option>Please Verify User----------------</option>
                <option value="Verified">APPROVED</option>
                <option value="Unverified">WAITING</option>
                <option value="Rejected">REJECTED</option>
              </select>
                        
                      </div>
                      <button type="submit" name="approve" class="btn btn-gradient-primary btn-icon-text">
                            <i class="mdi mdi-file-check btn-icon-prepend"></i> APPROVE </button>
          ...
          if ( isset( $_POST[ 'approve' ] ) ) {
            ...
            $update = "UPDATE reg SET status='$status' WHERE user_id='$user_id' ";

            $run = mysqli_query( $con, $update );

            if ( $run ) {

              echo "<script>alert('Employee Approval is submitted successfully !!')</script>";
