          ...
          <div class="content-wrapper">
             ...
             <div class="row">
                ...
                <div class="card badge-outline-light">
                  <div class="card-body">
                    <h4 class="card-title ">Un-Verified Shipper</h4>
                    ...
                    <table class="table table-striped">
                      ...
                      $get_trans = "SELECT * FROM reg where user='Loader' and status='Unverified'";
            ...
            ?>
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card badge-outline-light">
                  <div class="card-body">
                    <h4 class="card-title">Verified Shipper</h4>
                    <!-- <p class="card-description"> Add class <code>.table-striped</code>
                    </p> -->
                    <table class="table table-striped">
                      <thead>
                      ...
                      $get_trans = "SELECT * FROM reg where user='Loader' and status='Verified'";
            $run_trans = mysqli_query( $con, $get_trans );
            while ( $row_trans = mysqli_fetch_array( $run_trans ) ) {
