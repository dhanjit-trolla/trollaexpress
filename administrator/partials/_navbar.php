        ...
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="profile" data-toggle="dropdown" aria-expanded="false">
               <!--  <div class="nav-profile-img">
                ...
                $get_user = "SELECT * FROM admin WHERE mobile='$users'";
            ...
            <!-- <div class="user-name"> -->
              ...
              <p class="mb-1 text-black"><?php echo $user ?></p>
            ...
            $tlt_new = "SELECT * FROM contact";
            $run_new = mysqli_query($con,$tlt_new);
            $new = mysqli_num_rows($run_new);
            echo "

                  <i class='mdi mdi-cached mr-2 text-success'></i> Message <i style='color: green;'> $new </i></a>";?>
           ...
           <!--  <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="myLoads">
                <span class="menu-title">My Loads</span>
          ...
          <!--   <li class="nav-item">
            ...
            <li class="nav-item sidebar-actions">
              <span class="nav-link"> 
               ...
               <!-- <a class="nav-link" href="createLoads"><button class="btn btn-block btn-lg btn-gradient-primary mt-4" >+ Add a Load</button> </a> -->
                <!-- <div class="mt-4">
                  <div class="border-bottom">
