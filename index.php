...
<html style="font-size: 16px;">
  <head> 
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Trolla, Trollaexpress, HOME, Trolla Beyond Logistics, Our Product, What We Do, Running Truck, Idle Truck">
    <meta name="description" content="Trolla is a transportation-focused cloud-based mobile application. It is a SaaS-based freight marketplace built on an asset-light networking concept and powered by a proprietary algorithm that quickly matches trucks with the best rates.">
  ...
  <body data-home-page="home" data-home-page-title="Home" class="u-body u-overlap u-overlap-contrast u-overlap-transparent"><header class="u-align-center-sm u-align-center-xs u-black u-clearfix u-header u-header" id="sec-cf8a"><div class="u-clearfix u-sheet u-sheet-1">
	...
	"></path></svg></span>
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-align-center-xs u-color-scheme-u10 u-color-style-multicolor-1 u-custom-font u-text u-text-white u-text-1">BEYOND LOGISTICS<br>
        </h1>
        <p class="u-align-center-xs u-align-left-lg u-align-left-md u-align-left-sm u-align-left-xl u-custom-font u-text u-text-white u-text-2">
          <span class="u-text-custom-color-1"> &nbsp;RUNNING TRUCK&nbsp;&nbsp;IS&nbsp;BETTER THAN&nbsp;</span>
          <span class="u-text-custom-color-1">&nbsp;IDLE TRUCK </span>
        </p>
      </div>
    </section>
      ...
      <div class="u-expanded-width u-layout-horizontal u-list u-list-1">
        <div class="u-repeater u-repeater-1">
          <div class="u-align-center u-container-style u-custom-color-1 u-list-item u-repeater-item u-shape-rectangle u-video-cover u-list-item-1">
            <div class="u-container-layout u-similar-container u-container-layout-1"><span class="u-icon u-icon-circle u-text-white u-icon-1"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 55.017 55.017" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-fe73"></use></svg><svg class="u-svg-content" viewBox="0 0 55.017 55.017" x="0px" y="0px" id="svg-fe73" style="enable-background:new 0 0 55.017 55.017;"><g><path d="M51.688,23.013H40.789c-0.553,0-1,0.447-1,1s0.447,1,1,1h9.102l2.899,27H2.268l3.403-27h9.118c0.553,0,1-0.447,1-1
    ...
    c-0.132-0.017-0.264-0.042-0.394-0.075c-0.535-0.143-1.08,0.181-1.22,0.716C9.139,48.158,9.459,48.704,9.993,48.842z"></path>
          ...
          <div class="u-align-center u-container-style u-custom-color-1 u-list-item u-repeater-item u-shape-rectangle u-list-item-2">
            <div class="u-container-layout u-similar-container u-container-layout-2"><span class="u-icon u-icon-circle u-text-white u-icon-2"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 20 20" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-0269"></use></svg><svg class="u-svg-content" viewBox="0 0 20 20" id="svg-0269"><path d="M8 12C8 12.5523 7.55228 13 7 13C6.44772 13 6 12.5523 6 12C6 11.4477 6.44772 11 7 11C7.55228 11 8 11.4477 8 12Z" fill="currentColor"></path><path d="M13 13C13.5523 13 14 12.5523 14 12C14 11.4477 13.5523 11 13 11C12.4477 11 12 11.4477 12 12C12 12.5523 12.4477 13 13 13Z" fill="currentColor"></path><path d="M8 13.5C8 13.2239 8.22386 13 8.5 13H11.5C11.7761 13 12 13.2239 12 13.5C12 13.7761 11.7761 14 11.5 14H8.5C8.22386 14 8 13.7761 8 13.5Z" fill="currentColor"></path><path d="M4 2C2.89543 2 2 2.89543 2 4V14.5C2 15.3284 2.67157 16 3.5 16H4V16.5C4 17.3284 4.67157 18 5.5 18H6.5C7.32843 18 8 17.3284 8 16.5V16H12V16.5C12 17.3284 12.6716 18 13.5 18H14.5C15.3284 18 16 17.3284 16 16.5V16H16.5C17.3284 16 18 15.3284 18 14.5V4C18 2.89543 17.1046 2 16 2H4ZM13 16.5V16H15V16.5C15 16.7761 14.7761 17 14.5 17H13.5C13.2239 17 13 16.7761 13 16.5ZM7 16V16.5C7 16.7761 6.77614 17 6.5 17H5.5C5.22386 17 5 16.7761 5 16.5V16H7ZM3 4C3 3.44772 3.44772 3 4 3H16C16.5523 3 17 3.44772 17 4V14.5C17 14.7761 16.7761 15 16.5 15H16V9.74621C16 9.54181 15.9749 9.33817 15.9254 9.13987L15.1744 6.1362C15.0075 5.46845 14.4075 5 13.7192 5H6.28078C5.59248 5 4.9925 5.46845 4.82556 6.1362L4.07464 9.13987C4.02507 9.33817 4 9.54181 4 9.74621V15H3.5C3.22386 15 3 14.7761 3 14.5V4ZM5 15V10H15V15H5ZM5.14039 9L5.79571 6.37873C5.85135 6.15615 6.05134 6 6.28078 6H13.7192C13.9487 6 14.1486 6.15615 14.2043 6.37873L14.8596 9H5.14039Z" fill="currentColor"></path></svg>
            
            
          </span>
              <h5 class="u-custom-font u-text u-text-default u-text-3">FLEET MANAGING</h5>
              <p class="u-custom-font u-text u-text-4">Service to the truck driver which can consume time and cost</p>
            </div>
          </div>
          <div class="u-align-center u-container-style u-custom-color-1 u-hidden-xs u-list-item u-repeater-item u-shape-rectangle u-video-cover u-list-item-3">
            <div class="u-container-layout u-similar-container u-container-layout-3"><span class="u-icon u-icon-circle u-text-white u-icon-3"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 48 48" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-8886"></use></svg><svg class="u-svg-content" viewBox="0 0 48 48" id="svg-8886"><path clip-rule="evenodd" d="M47,40L47,40c0,2.762-2.238,5-5,5l0,0H6l0,0c-2.762,0-5-2.238-5-5V11  c0-2.209,1.791-4,4-4l0,0h20.171l8.099-2.934c0.513-0.187,1.081,0.078,1.268,0.589L35.391,7H39c2.209,0,4,1.791,4,4v2l0,0  c2.209,0,4,1.791,4,4V40z M5,9L5,9c-1.104,0-2,0.896-2,2s0.896,2,2,2h3.445l0,0h0.189c0.013-0.005,0.021-0.016,0.034-0.021L19.65,9  H5z M34.078,9.181l-1.062-2.924l-0.001,0v0L30.964,7h0.003l-5.514,2h-0.01l-11.039,4h21.062L34.078,9.181z M41,11  c0-1.104-0.896-2-2-2h-2.883l1.454,4H41l0,0V11z M43,15H5l0,0c-0.732,0-1.41-0.211-2-0.555V40c0,1.657,1.344,3,3,3h36  c1.657,0,3-1.343,3-3v-7h-4c-2.209,0-4-1.791-4-4s1.791-4,4-4h4v-8C45,15.896,44.104,15,43,15z M45,31v-4h-4c-1.104,0-2,0.896-2,2  s0.896,2,2,2H45z M41,28h2v2h-2V28z" fill-rule="evenodd"></path></svg>
            
            
          </span>
              <h5 class="u-custom-font u-text u-text-default u-text-5">SECURE PAYMENT</h5>
              <p class="u-custom-font u-text u-text-6"> Secure earning by referring other shippers or transporters on the platform</p>
            </div>
          </div>
        </div>
...
c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path></svg>
    ...
    <section class="u-align-center u-clearfix u-section-3" id="sec-996a">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <p class="u-custom-font u-text u-text-2"> Trolla is an online SaaS freight marketplace with an asset-light networking model complemented by a custom algorithm-based, robust application to speed-up &amp; automate operations – for Shippers and Transporter alike.</p>
          ...
          <div class="u-gallery-inner u-gallery-inner-1">
            <div class="u-effect-fade u-effect-hover-zoom u-gallery-item u-radius-8 u-shape-round">
              <div class="u-back-slide u-back-slide-1" data-image-width="5928" data-image-height="3952">
                <img class="u-back-image u-expanded" src="images/home1.jpg">
              </div>
            ...
            <div class="u-effect-fade u-effect-hover-zoom u-gallery-item u-radius-8 u-shape-round">
              <div class="u-back-slide u-back-slide-2" data-image-width="7142" data-image-height="3765">
                <img class="u-back-image u-expanded" src="images/home2.jpg">
              </div>
            ...
            <div class="u-effect-fade u-effect-hover-zoom u-gallery-item u-radius-8 u-shape-round">
              <div class="u-back-slide u-back-slide-3" data-image-width="4096" data-image-height="2731">
                <img class="u-back-image u-expanded" src="images/home3.png">
              </div>
        ...
        <p class="u-align-center u-custom-font u-text u-text-6"> Churn out more profit by reducing miscellaneous cost and making the most out of every trip with our advange algorithms and an experianced team.</p>
        <p class="u-align-center u-custom-font u-text u-text-7"> We are attempting to solve the inefficiencies in the Indian surface transport sector through a marketplace and technology-enabled services.</p>
        <p class="u-align-left u-custom-font u-text u-text-8"> One stop solution for all the transportation needs starting from finding the right transporter, real time tracking to having the goods insured.</p>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="sec-f218">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-custom-font u-text u-text-default u-text-1">OTHER BENIFIT</h2>
        <img class="u-expanded-width-xs u-image u-image-default u-image-1" src="images/404errorwithpeopleholdingthenumbers-cuate11.svg" alt="" data-image-width="1380" data-image-height="920">
        <h3 class="u-align-center u-custom-font u-text u-text-custom-color-1 u-text-2"> 0% Commision on all bookings</h3>
        <p class="u-align-center u-custom-font u-text u-text-3"> We charge no commision for posting load and connecting shippers with transporters.</p>
        <img class="u-expanded-width-xs u-image u-image-default u-preserve-proportions u-image-2" src="images/Profilepic-cuate.svg" alt="" data-image-width="500" data-image-height="500">
        <h3 class="u-align-center u-custom-font u-text u-text-custom-color-1 u-text-4"> Branding for your transport business</h3>
        <p class="u-align-center u-custom-font u-text u-text-5"> Create your branding for your transport company and increase business by 50%</p>
        <img class="u-expanded-width-xs u-image u-image-default u-image-3" src="images/Security-pana.svg" alt="" data-image-width="750" data-image-height="500">
        <h3 class="u-align-center u-custom-font u-text u-text-custom-color-1 u-text-6"> Safe, Secure &amp; Private Bidding Process.</h3>
        <p class="u-align-center u-custom-font u-text u-text-7"> Your load bidding process is completely private. Our tech makes online truck booking and safe and verified.</p>
      </div>
    </section>
    <section class="u-align-center u-clearfix u-white u-section-5" id="carousel_f3d8">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-align-left u-container-style u-expanded-width-md u-expanded-width-sm u-group u-shape-rectangle u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <img class="u-image u-image-round u-radius-24 u-image-1" src="images/Screenshot1.png" alt="" data-image-width="442" data-image-height="936">
          </div>
        </div>
              ...
              <div class="u-size-30">
                <div class="u-layout-col">
                  <div class="u-container-style u-layout-cell u-radius-10 u-size-20 u-white u-layout-cell-3">
                    <div class="u-container-layout u-container-layout-4"><span class="u-custom-color-1 u-icon u-icon-circle u-spacing-18 u-text-white u-icon-3"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 64 64" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-c3ac"></use></svg><svg class="u-svg-content" viewBox="0 0 64 64" id="svg-c3ac" style="enable-background:new 0 0 64 64;"><g><path d="M63.69172,44.81383c-0.62661-1.75697-1.91092-3.12349-3.61652-3.87351s-3.5858-0.7603-5.30169-0.03085L43.2661,45.76935   c0.01028-0.13358,0.02057-0.28772,0.02057-0.43158c0-2.23984-1.81861-4.05838-4.05851-4.05838h-8.30176   c-0.33914,0-0.66787-0.07193-0.97603-0.21579l-7.03815-3.17485c-1.09932-0.50344-2.32205-0.77059-3.53437-0.77059h-5.95927   v-0.57537c0-1.13017-0.91432-2.0549-2.0549-2.0549H0v25.93287h11.36368c1.14058,0,2.0549-0.92467,2.0549-2.0549v-1.61304h3.29808   l12.27812,3.94538c1.01717,0.31851,2.06519,0.48294,3.12337,0.48294c1.66459,0,3.32893-0.40072,4.80853-1.19188L64,45.64606   L63.69172,44.81383z M7.22301,56.60895c-0.79116,0-1.43833-0.6473-1.43833-1.43846c0-0.80138,0.64717-1.44868,1.43833-1.44868   s1.43846,0.6473,1.43846,1.44868C8.66147,55.96165,8.01417,56.60895,7.22301,56.60895z M35.97109,58.1707   c-1.94178,1.03767-4.25354,1.23289-6.34958,0.56508l-12.43214-3.9968l-3.77079-0.04108V39.17307h5.95927   c0.92461,0,1.84946,0.2055,2.68163,0.58566l7.03802,3.18514c0.57543,0.25686,1.19188,0.39043,1.82889,0.39043h8.30176   c1.1096,0,2.0036,0.9041,2.0036,2.00348c0,1.10966-0.894,2.00354-2.0036,2.00354h-10.7471v2.0549h10.7471   c0.75014,0,1.44874-0.19522,2.04474-0.5548L55.57495,42.8c1.19175-0.50344,2.49664-0.49316,3.67836,0.02057   c0.90404,0.40066,1.64377,1.05824,2.13693,1.89048L35.97109,58.1707z"></path><path d="M9.30727,30.34497l6.39875-3.54516l6.26605,3.77493l-1.39431-7.18112l4.59757-3.98721l-1.69745,7.31326   c-0.09231,0.39533,0.05719,0.80771,0.38128,1.05254c0.32509,0.24482,0.76156,0.27542,1.11675,0.07826l7.1129-3.93973   l6.96339,4.19509c0.33587,0.20422,0.7768,0.20085,1.11876-0.03813c0.33212-0.23228,0.49667-0.63915,0.41941-1.03749   l-1.54921-7.98131l0.14624-0.12686l4.60622,4.29712l-1.65393,7.12581l6.39875-3.54516l6.26593,3.77493l-1.39418-7.18112   l5.52631-4.79279l-7.26039-0.893l-2.85057-6.73701l-3.09289,6.62914l-5.57573,0.4813l5.02689-4.35927   c0.30703-0.26589,0.42744-0.68731,0.30904-1.07561c-0.1184-0.3883-0.45353-0.67075-0.85688-0.72042l-8.07011-0.99233   L33.3982,3.44598c-0.15853-0.37376-0.52175-0.61958-0.92712-0.62711c-0.00702,0-0.01304,0-0.01906,0   c-0.39834,0-0.76256,0.23078-0.93113,0.59299l-3.43755,7.36775l-8.10021,0.69935c-0.88109,0.07543-1.26465,1.16423-0.61306,1.77496   l5.58025,5.20499l-6.10664-0.75109l-2.85045-6.73701l-3.09289,6.62914L5.6121,18.22908l5.34897,4.99008L9.30727,30.34497z    M28.85192,12.77583c0.36623-0.03161,0.68731-0.25586,0.84283-0.58898l2.71111-5.81203l2.49939,5.90634   c0.14348,0.33864,0.45654,0.57443,0.82076,0.61958l6.36538,0.78263l-4.84528,4.20212   c-0.27794,0.24081-0.40536,0.61105-0.33512,0.97176l1.2221,6.29615l-5.49345-3.30912   c-0.31649-0.19146-0.71086-0.19536-1.02745-0.01856l-5.61085,3.10794l1.44987-6.24749   c0.08328-0.3577-0.03111-0.73296-0.29901-0.9838l-4.69076-4.3752L28.85192,12.77583z"></path>
</g></svg></span>
                      <h3 class="u-align-center u-custom-font u-text u-text-default u-text-7">Frieght Partner</h3>
                      <p class="u-align-left u-custom-font u-text u-text-palette-5-dark-2 u-text-8">Find loads to give specific rate with assigning driver and vehicle&nbsp;</p>
                    </div>
                  </div>
                  <div class="u-container-style u-layout-cell u-radius-10 u-size-40 u-white u-layout-cell-4">
                    <div class="u-container-layout u-container-layout-5"><span class="u-custom-color-1 u-icon u-icon-circle u-spacing-18 u-icon-4"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 24 24" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-2d77"></use></svg><svg class="u-svg-content" viewBox="0 0 24 24" id="svg-2d77"><path d="M20.53,7H19V2a1,1,0,0,0-.44-.83,1,1,0,0,0-.93-.1l-15,6a1.16,1.16,0,0,0-.36.25A2.49,2.49,0,0,0,1,9.47V20.53A2.48,2.48,0,0,0,3.47,23H20.53A2.48,2.48,0,0,0,23,20.53V9.47A2.48,2.48,0,0,0,20.53,7ZM17,7H8.19L17,3.48Zm4,10H17a2,2,0,0,1,0-4h4Zm-4-6a4,4,0,0,0,0,8h4v1.53a.47.47,0,0,1-.47.47H3.47A.47.47,0,0,1,3,20.53V9.47A.47.47,0,0,1,3.47,9H20.53a.47.47,0,0,1,.47.47V11Z"></path><circle cx="18" cy="15" r="1"></circle></svg></span>
                      <h3 class="u-align-center u-custom-font u-text u-text-default u-text-9">Frieght Payment</h3>
                      <p class="u-align-left u-custom-font u-text u-text-palette-5-dark-2 u-text-10"> Our payment gateway charge alternatives for the benefit of drivers with the choice to choose one default charge option.</p>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <footer class="u-align-center-md u-align-center-sm u-align-center-xs u-clearfix u-footer u-grey-90" id="sec-e1ec"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <ul class="u-align-left-md u-align-left-sm u-align-left-xs u-custom-font u-spacing-10 u-text u-text-3">
          ...
          <li>
           ...
           <li>
             <a href="pricing-policy" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-body-alt-color u-btn-3">Pricing policy</a>
           </li>
