             ...
             <div class="row">
               <div class="col-12">
                  ...
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select class="form-control" name="gender" >
                                <option selected="<?php echo $gender=='Male'?true:false ?>">Male</option>
                                <option selected="<?php echo $gender=='Female'?true:false ?>">Female</option>
                              </select>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label" style="color: #000;">Post Code</label>
                            <div class="col-sm-9">
                ...
                $country = $_POST['country'];
                                            ...
                                            $update = "UPDATE reg SET name='$name', email='$email', password='$password', mobile='$mobile', company_name='$company_name', alt_num='$alt_num', gender='$gender', dob='$dob', material='$material', partner='$partner', add1='$add1', add2='$add2', state='$state', city='$city', postcode='$postcode', country='$country' WHERE user_id='$user_id' ";
