...
<head>
  ...
  <meta charset="utf-8">
  <meta name="keywords"
    content="TROLLA SERVICES, CHECK OUR PRODUCT, Shipper, Freight Partner, Transporter, Truck Driver, Driver">
  <meta name="description"
    content="Shipper is the primary owner of the goods, who needs it to be shipped from one location to destination. Partner should be anyone like transporter, truck owner, broker/agents who can take the risk and deliver the good to destination. Driver can be the owner of vehicle and his primary goal is to ensure maximum utilisation of the vehicle.">
  ...
  <link rel="stylesheet" href="assets/css/style.css?v=<?= $version ?>" media="screen">
  <!-- CSS only -->
...
<body data-home-page="home" data-home-page-title="Home"
  ...
  <header class="u-align-center-sm u-align-center-xs u-black u-clearfix u-header u-header" id="sec-cf8a">
    <div class="u-clearfix u-sheet u-sheet-1">
      <a href="home" data-page-id="81999359" class="u-image u-logo u-image-1" data-image-width="2333"
        ...
        <div class="u-custom-menu u-nav-container">
          <ul class="u-custom-font u-nav u-spacing-20 u-unstyled u-nav-1">
            <li class="u-nav-item"><a
                ...
                href="about" style="padding: 10px;">About</a>
            </li>
            <li class="u-nav-item"><a
                class="u-button-style u-nav-link u-text-active-custom-color-1 u-text-hover-custom-color-1 u-text-white"
                href="services" style="padding: 10px;">Services</a>
            </li>
            <li class="u-nav-item"><a
                class="u-button-style u-nav-link u-text-active-custom-color-1 u-text-hover-custom-color-1 u-text-white"
                href="blogs" style="padding: 10px;">Blogs</a>
            </li>
            <li class="u-nav-item"><a
                class="u-button-style u-nav-link u-text-active-custom-color-1 u-text-hover-custom-color-1 u-text-white"
            ...
            <li class="u-nav-item"><a
                class="u-button-style u-nav-link u-text-active-custom-color-1 u-text-hover-custom-color-1 u-text-white"
                href="login" style="padding: 10px;">Login/Signup</a>
            </li>
          </ul>
        </div>
          ...
          <div
            ...
            <div class="u-inner-container-layout u-sidenav-overflow">
              ...
              <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                ...
                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="services"
                    style="padding: 10px;">Services</a>
                </li>
                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="blogs"
                    style="padding: 10px;">Blogs</a>
                </li>
                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="contact"
                    style="padding: 10px;">Contact</a>
                </li>
                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="login"
                    style="padding: 10px;">Login/Signup</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="u-hidden-xs u-social-icons u-spacing-10 u-social-icons-1">
        <a class="u-social-url" title="facebook" target="_blank"
          href="https://www.facebook.com/Trollaexpress-101391802454922"><span
            ...
            </svg><svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-c358">
        ...
        <a class="u-social-url" target="_blank" data-type="LinkedIn" title="LinkedIn"
          href="https://www.linkedin.com/company/trollaexpress"><span
            ...
            </svg><svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-66f0">
              <circle fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
        ...
        <a class="u-social-url" target="_blank" data-type="Email" title="Email" href="contact"><span
            class="u-icon u-social-email u-social-icon u-icon-3"><svg class="u-svg-link"
              preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style="">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-919e"></use>
            </svg><svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-919e">
              <circle fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
  ...
  <section class="u-clearfix u-image u-shading u-section-1" id="sec-60a4" data-image-width="1280"
      ...
      <div class="row g-5">
        ...
        <div class="col-lg-8">
          ...
          <article class="blog-details">
            ...
            <div class="post-img">
              <img src="assets/images/tblog.png" alt="" class="img-fluid">
            </div>

            <h2 class="title">What's new Transporter in 2022 ?</h2>

            <div class="meta-top">
              <ul>
                <li>Abhisekh Kumer</li>
                <li>Sept 20, 2022</li>
              </ul>
            </div>
